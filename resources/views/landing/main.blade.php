                    ...
                    <div class="hero-inner">
						<div class="hero-copy">
	                        ...
	                        <p class="hero-paragraph">
                                Este servidor processa todas as informações utilizadas no aplicativo eMazaGame. Somente utilizadores permitidos tem acesso a área restrita deste servidor.   
                            </p>
	                        <div class="hero-cta">
                                <a class="button button-primary" href="https://play.google.com/store/apps/details?id=explicador.co.mz" target="_blank">Baixar aplicativo</a>
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">
                                        Através do eMazaGame você pode aprender tudo o que precisa. Aprenda, desde línguas, matemática, tecnologia e outras ciências exactas e puras de forma divertida usando este aplicativo. Baixe agora!!!
                                    </p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                ...
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"></span><span class="pricing-table-price-amount h1">Gratuito</span><span class="text-xs">/Sempre</span></div>
                                        </div>
										<div class="pricing-table-features-title text-xs pt-24 pb-24">Todos os recursos básicos</div>
